...
int n,m;
int l1[55555],r1[55555],l2[222222],r2[222222];
int ans[222222],sf[222222];
int arr[1111],pre[1111][1111],mid[1111][1111],suf[1111][1111];
int cnt,ll[1111],rr[1111];
int l[1111],r[1111];
int cp,cm,cs,ct;
int re[555555],att[555555];
int tot_inter;
std::vector<int>v[1111];
struct hashtable
{
	int head[mod+10],nxt[555555],val[555555],cnt;
	inline void ins(int x){
		int t=x%mod;++cnt;nxt[cnt]=head[t];val[cnt]=x;head[t]=cnt;
	}
